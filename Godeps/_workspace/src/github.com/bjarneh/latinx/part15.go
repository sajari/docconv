...
// Generated from http://unicode.org/Public/MAPPINGS/ISO8859/8859-15.TXT

func newISO_8859_15Converter() *Converter {

    converter := new(Converter)
    converter.id = "Latin-9/ISO-8859-15"
    ...
    converter.latinToUtf8[208] = []byte("Ð") // LATIN CAPITAL LETTER ETH
    ...
    converter.latinToUtf8[222] = []byte("Þ") // LATIN CAPITAL LETTER THORN
    ...
    converter.latinToUtf8[240] = []byte("ð") // LATIN SMALL LETTER ETH
    ...
    converter.latinToUtf8[254] = []byte("þ") // LATIN SMALL LETTER THORN
