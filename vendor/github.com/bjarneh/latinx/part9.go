...
// Generated from http://unicode.org/Public/MAPPINGS/ISO8859/8859-9.TXT

func newISO_8859_9Converter() *Converter {

    converter := new(Converter)
    converter.id = "Latin-5/ISO-8859-9"
    ...
    converter.latinToUtf8[208] = []byte("Ğ") // LATIN CAPITAL LETTER G WITH BREVE
    ...
    converter.latinToUtf8[221] = []byte("İ") // LATIN CAPITAL LETTER I WITH DOT ABOVE
    converter.latinToUtf8[222] = []byte("Ş") // LATIN CAPITAL LETTER S WITH CEDILLA
    ...
    converter.latinToUtf8[240] = []byte("ğ") // LATIN SMALL LETTER G WITH BREVE
    ...
    converter.latinToUtf8[253] = []byte("ı") // LATIN SMALL LETTER DOTLESS I
    converter.latinToUtf8[254] = []byte("ş") // LATIN SMALL LETTER S WITH CEDILLA
    ...
    converter.utf8ToLatin[286] = 208 // [Ğ]  U+011E => D0
    ...
    converter.utf8ToLatin[304] = 221 // [İ]  U+0130 => DD
    converter.utf8ToLatin[350] = 222 // [Ş]  U+015E => DE
    ...
    converter.utf8ToLatin[287] = 240 // [ğ]  U+011F => F0
    ...
    converter.utf8ToLatin[305] = 253 // [ı]  U+0131 => FD
    converter.utf8ToLatin[351] = 254 // [ş]  U+015F => FE
